    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between my-schedule mb-4">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="font-weight-bold">Batches</h4>
                </div>  
                    ...
                    <div class="card card-block card-stretch">
                        <div class="card-body p-0">
                            <div class="d-flex justify-content-between align-items-center p-3">
                                <h5 class="font-weight-bold">Batches List</h5>
                            ...
                            <table class="table data-table mb-0">
                                    <thead class="table-color-heading">
                                        <tr class="text-light">  
                                            <th scope="col">
                                                <label class="text-muted mb-0" >Batch No.</label>
                                            </th> 
                                            <th scope="col">
        ...
        <tr class="white-space-no-wrap"> 
           ...
           @php } @endphp
            ...
            <a class="" data-toggle="tooltip" data-placement="top" title="Edit" href="{{ route('batches.edit', $batch->id) }}">
            ...
            <form id="delete-batch-{{ $batch->id }}" action="{{ route('batches.destroy', ['batch' => $batch->id]) }}" method="POST" style="display:inline-block;">
            @csrf
            @method('DELETE')
            <a href="#" class="badge bg-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this batch?')) { document.getElementById('delete-batch-{{ $batch->id }}').submit(); }">
